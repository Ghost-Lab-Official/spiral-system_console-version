...
//        calculateTheTotalNumberOfSpots();
    ...
    public static void viewAllSpots() throws Exception {
        ...
        while (rs.next()) {
            ...
            String[][] table = new String[][] { { "Spot Id", "User Id", "Category Id", "Location Id", "Spot Name", "Spot Description", "Views", "Viewers", "Rates", "Registration Date", "Updated Date" },
                    { spot_id, user_id, category_id, location_id, spot_name, spot_description, String.valueOf(views), String.valueOf(viewers), String.valueOf(rates),
